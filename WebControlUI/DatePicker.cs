...
namespace WebControlUI
{
    ...
    [ToolboxBitmap(typeof(DatePicker), "WebControlUI.CalendarToolbox.bmp")]
    public class DatePicker : TextBox
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            scriptManager.RegisterClientScriptResource(typeOfThis, "WebControlUI.Javascript.datepicker.js");
            ...
            //{
                ...
                csslink.Attributes.Add("href", Page.ClientScript.GetWebResourceUrl(typeOfThis, "WebControlUI.Style.theme.css"));
        ...
        private void RenderPictureButton(HtmlTextWriter writer)
        {
            ...
            writer.WriteAttribute(HtmlTextWriterAttribute.Src.ToString(),
                                  Page.ClientScript.GetWebResourceUrl(this.GetType(), "WebControlUI.CalendarToolbox.bmp"));
