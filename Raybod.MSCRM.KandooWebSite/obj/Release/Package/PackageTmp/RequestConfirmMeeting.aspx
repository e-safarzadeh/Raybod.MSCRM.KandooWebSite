<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RequestConfirmMeeting.aspx.cs" Inherits="Raybod.MSCRM.KandooWebSite.RequestConfirmMeeting" %>
                    ...
                    <tr>
                        <td class="style15" style="width: 134px">
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" Style="font-size: x-small;
                                color: #FFFFFF; text-decoration: none" CausesValidation="False" OnClick="LinkRequestList_Click">لیست جلسات</asp:LinkButton>
                        </td>
                    ...
                    <table style="width: 100%; height: auto; font-family: Tahoma; font-size: x-small;"
                        ...
                        <tr>
                            <td colspan="2" style="height: 9px; font-size: x-small; text-align: right">
                                &nbsp;اطلاعات<span class="style13" style="text-align: left"> با موفقيت ثبت شد.&nbsp;</span>
                            </td>
                        </tr>
                        <tr>
