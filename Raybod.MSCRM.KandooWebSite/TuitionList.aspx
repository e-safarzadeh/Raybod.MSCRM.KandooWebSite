<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="TuitionList.aspx.cs" Inherits="Raybod.MSCRM.KandooWebSite.TuitionList" %>
                ...
                <table style="width: 100%; font-family: Tahoma; font-size: x-small;" cellpadding="0"
                    ...
                    <tr>
                        <td class="style14" colspan="2" style="text-align: right; height: 17px;">
                            <b>&nbsp; &nbsp;<asp:LinkButton ID="LinkAddRequest" runat="server" OnClick="LinkAddRequest_Click">درخواست حق التدریس جديد</asp:LinkButton>
                            </b>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: center; height: 19px;" valign="top">
                            <asp:UpdatePanel ID="AjaxUpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="RequestTuitionListView" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        Width="100%" Style="margin-top: 0px" DataKeyNames="teacherpaymentrequestid" 
                                        OnRowDataBound="RequestTuitionListView_RowDataBound" AllowPaging="True"
                                        OnPageIndexChanging="RequestTuitionListView_PageIndexChanging"
                                        OnRowCancelingEdit="RequestTuitionListView_RowCancelingEdit">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="paymentstatus" HeaderText="وضعیت پرداخت">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="totalteachinghours_ds" HeaderText="تعداد ساعات تدریس شده">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="200px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="teachersalary" HeaderText="حق التدریس ساعتی">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="250px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="deductions" HeaderText="درصد کسورات">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="250px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="theamountpaid" HeaderText="مبلغ پرداخت شده">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="250px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="typeofpayment" HeaderText="نوع پرداخت">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="250px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="dateofpayment" HeaderText="تاریخ پرداخت">
                                                <HeaderStyle HorizontalAlign="center" />
                                                <ItemStyle Width="250px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="teacherpaymentrequestid" HeaderText="teacherpaymentrequestid" Visible="False" />
                                        </Columns>
