<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RequestConfirm.aspx.cs" Inherits="CrmCustomerRequest.RequestConfirm" %>
    ...
    <table style="width: 100%; height: 154px;" border="0" cellpadding="0" cellspacing="0"
        ...
        <tr __designer:mapid="32" valign="top">
            <td width="10" style="height: 25px" __designer:mapid="33">
                <img width="14" height="38" src="images/page_03.jpg" complete="complete" __designer:mapid="34" />
            </td>
            <td align="right" class="page_title" style="background-image: url('images/page_02.jpg');
            ...
            <td width="14" style="height: 25px" __designer:mapid="36">
                <img width="14" height="38" src="images/page_01.jpg" complete="complete" __designer:mapid="37" />
            </td>
        </tr>
                    ...
                    <table style="width: 100%; height: auto; font-family: Tahoma; font-size: x-small;"
                        ...
                        <tr>
                            ...
                            <td class="style10" style="height: 5px; text-align: right">
                                <asp:TextBox ID="txtCaseNumber" runat="server" Width="296px" ReadOnly="True" Font-Names="Tahoma"
                        ...
                        <tr>
                            <td class="style14" colspan="2" style="text-align: right; height: 17px;">
                                <b>&nbsp; &nbsp;<asp:LinkButton ID="LinkAddRequest" runat="server" OnClick="LinkAddRequest_Click">درخواست جديد</asp:LinkButton>
                                </b>
                            </td>
                        </tr>
                    </table>
